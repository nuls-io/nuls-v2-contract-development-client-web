...
//正式、测试网络的api
export let LOCALHOST_API_URL = 'http://127.0.0.1:80/offlineSmartContract';
...
export const defaultData = [
  ...
  {name: 'Official',chainId:10,assetId:1,decimals:8,chainName:'tNULS', urls: 'http://apitn10.nulscan.io', delay: '10ms', selection: false, isDelete: true},
  {name: 'Official',chainId:2,assetId:1,decimals:8,chainName:'tNULS', urls: 'http://10.3.2.244:18003', delay: '10ms', selection: true, isDelete: true},
];
